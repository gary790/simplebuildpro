...
export const projectVersions = pgTable(
  ...
  (table) => ({
    projectVersionIdx: uniqueIndex('versions_project_version_idx').on(
      table.projectId,
      table.versionNumber,
    ),
...
export const projectIntegrations = pgTable(
  ...
  (table) => ({
    ...
    providerIdx: uniqueIndex('project_integrations_provider_unique').on(
      table.projectId,
      table.provider,
    ),
...
export const projectIntegrationsRelations = relations(projectIntegrations, ({ one }) => ({
  ...
  connection: one(userConnections, {
    fields: [projectIntegrations.connectionId],
